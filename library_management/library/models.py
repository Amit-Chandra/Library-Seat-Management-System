...
class Library(models.Model):
    ...
    # Add image field (optional)
    image = models.ImageField(upload_to='library_images/', null=True, blank=True, default='default_library_image.jpg')
...
class UserProfile(models.Model):
    ...
    role = models.CharField(max_length=20, choices=(('admin', 'Admin'), ('student', 'Student')))
